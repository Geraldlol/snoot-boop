...
const CURRENCY_DISPLAY = [
  { id: 'bp' as const, iconSrc: starterArt.icons.boopCoin, label: 'BP', fullName: 'Boop Points', color: '#E94560', primary: true },
  { id: 'pp' as const, iconSrc: starterArt.icons.pawSpirit, label: 'PP', fullName: 'Purr Power', color: '#FFD700', primary: true },
  { id: 'qi' as const, iconSrc: starterArt.icons.qiOrb, label: 'Qi', fullName: 'Qi Energy', color: '#00BFFF', primary: false },
  { id: 'jadeCatnip' as const, iconSrc: starterArt.icons.lotusBadge, label: 'JC', fullName: 'Jade Catnip', color: '#7FFFD4', primary: false },
  { id: 'spiritStones' as const, iconSrc: starterArt.icons.clawCharm, label: 'SS', fullName: 'Spirit Stones', color: '#9370DB', primary: false },
  { id: 'destinyThreads' as const, iconSrc: starterArt.icons.talisman, label: 'DT', fullName: 'Destiny Threads', color: '#D3B8FF', primary: false },
  { id: 'gooseFeathers' as const, iconSrc: starterArt.icons.koiTreat, label: 'GF', fullName: 'Goose Feathers', color: '#F5F5F5', primary: false },
];
...
export default function ResourceBar() {
  ...
  return (
    <div className="absolute top-0 left-0 right-0 z-10 flex items-center gap-1 px-4 py-2 bg-black/50 backdrop-blur-sm border-b border-white/10">
      {CURRENCY_DISPLAY.map(({ id, iconSrc, label, fullName, color, primary }, idx) => {
